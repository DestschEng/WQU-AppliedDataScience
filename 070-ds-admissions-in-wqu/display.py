...
@app.callback(
    ...
    Input("demo-plot-dropdown", "value")
)
def display_demo_graph(graph_name: str) -> dcc.Graph:
...
def display_group_size(effect_size):
    ...
    text = f"To detect a effect size of {effect_size}, you would need {n_obs} observations"
